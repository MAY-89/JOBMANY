	...
	<div class="container resume-top">
		...
		<hr/>
			...
			<div class="row mb-3">
				...
				<div class="col-md-5">
				<input type="date" name="rbirth" id='birth' class="form-control" value="${resume.rbirth }"/>
				</div>
			</div>
			<div class="row mb-3">
		...
		<div class="container">
			...
			<div class="row">
				<div class='col'>
					<input type="file" name="portfoliofile" class="form-control col-md-6" value="${resume.portfolio }"/>
				</div>
			</div>		
		</div>
		<hr/>
