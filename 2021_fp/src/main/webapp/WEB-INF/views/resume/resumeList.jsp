...
<section class="container resumeList">
	<div class="container resume-top">
		<div class="row">
			...
			<div class="col-md-2">
				<input class="form-control resume-btn" type="submit"
					value="이력서" onclick="location.href='resume'" />
			</div>
		</div>
	</div>
	<div class="container">
	...
	<div class="listBoard">
		<table class="table">
		  <thead >
		    <tr>
		      <th scope="col">rno</th>
		      <th scope="col">rTitle</th>
		      <th scope="col">rWriter</th>
...
<script type="text/javascript">
	...
	function loginWithKakao() {
		Kakao.init('dd10335995b0b7885333111a4a0df60b');	
		url: '/v2/user/me',
		Kakao.Auth.login({
